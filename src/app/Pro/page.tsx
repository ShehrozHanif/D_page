...
export default function Item(){
    const items = [
        ...
        { id: 2, title: "Gree AC", description: "Inverter With AI Tech",price:50000,image:ac },
        ...
        { id: 5, title: "Iphone", description: "1 TB Storage Rose Gold.",price:100000,image:oven},
        { id: 6, title: "Oven", description: "Without Using Electricity.",price:100000,image:iphone},
                        ...
                        return(
                            <div className="border border-blue-600 rounded-lg py-3 px-5">
                                ...
                                <h3 className="text-lg font-semibold">RS:{item.price}</h3>
                                 ...
                                 <Link href={`Laptops/${item.id}`}><button className="mt-2 bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700">Add To Cart</button>
                                 </Link>
